...
@Code
    ...
    Validation.RequireField("tbName", "Fadlan magacaa u qor.")
    Validation.RequireField("tbEmail", "Fadlan cinwaankaaga iimaylka u qor.")
                ...
                <div class="media-container-column col-lg-8">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            @Q1<br />
                            <input id="Al" name="A1" type="radio" value="Meel keliya isla mar" /> Meel keliya isla mar.<br />
                            <input id="Al" name="A1" type="radio" value="Laba meelood oo keliya isku mar" /> Laba meelood oo keliya isku mar.<br />
                            <input id="Al" name="A1" type="radio" value="Meel kasta isla mar" /> Meel kasta isla mar.<br />
                        </div>
                        <div class="form-group">
                            @Q2<br />
                            <input id="A2" name="A2" type="radio" value="Qorraxda, dayaxa iyo xiddigaha." /> Qorraxda, dayaxa iyo xiddigaha.<br />
                            <input id="A2" name="A2" type="radio" value="Kalluunka, shimbirraha iyo haadda." /> Kalluunka, shimbirraha iyo haadda.<br />
                            <input id="A2" name="A2" type="radio" value="Nin." /> Nin.<br />
                        </div>

                        <div class="form-group">
                            @Q3<br />
                            <input id="A3" name="A3" type="radio" value="In isaga ragga keliyuhu jeclaado." /> In isaga ragga keliyuhu jeclaado.<br />
                            <input id="A3" name="A3" type="radio" value="In isaga dumarka keliyuhu jeclaado." /> In isaga dumarka keliyuhu jeclaado.<br />
                            <input id="A3" name="A3" type="radio" value="In isaga ragga iyo dumarka, iyo carruurtuba ay wada jeclaadaan." /> In isaga ragga iyo dumarka, iyo carruurtuba ay wada jeclaadaan.
<br />
                        </div>

                        <div class="form-group">
                            @Q4<br />
                            <input id="A4" name="A4" type="radio" value="Wuxuu kala soocay birriga iyo badaha." /> Wuxuu kala soocay birriga iyo badaha.<br />
                            <input id="A4" name="A4" type="radio" value="Wuxuu uumay nin." /> Wuxuu uumay nin.<br />
                            <input id="A4" name="A4" type="radio" value="Wuxuu yiri, &quot;Iftiin ha ahaado&quot;" /> Wuxuu yiri, "Iftiin ha ahaado"<br />
                        </div>

                        <div class="form-group">
                            @Q5<br />
                            <input id="A5" name="A5" type="radio" value="Dembigeenna." /> Dembigeenna.<br />
                            <input id="A5" name="A5" type="radio" value="Innaga iyo dembigeennaba." /> Innaga iyo dembigeennaba.<br />
                            <input id="A5" name="A5" type="radio" value="Innaga." /> Innaga.<br />
                        </div>
                        ...
                        <div class="form-group">
                            @Q9<br />
                            <input id="A9" name="A9" type="radio" value="Run" /> Run<br />
                            <input id="A9" name="A9" type="radio" value="Been" /> Been<br />
                        </div>
                        <div class="form-group">
                            @Q10<br />
                            <input id="A10" name="A10" type="radio" value="Run" /> Run<br />
                            <input id="A10" name="A10" type="radio" value="Been" /> Been<br />
                        </div>
